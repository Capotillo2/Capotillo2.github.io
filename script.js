...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    document.getElementById('messageContainer').innerHTML = 'Gracias Nikol bb sabia que ibas a querer jajaja';
...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        ...
        case 1:
            ...
            document.getElementById('noBtn').innerHTML = '¡¿Realmente estas segura te puedes arrepentir?!';
            document.getElementById('noBtn').style.backgroundColor = '#004f87';
            document.getElementById('sadGifContainer').style.display = 'none';
        ...
        case 2:
            ...
            document.getElementById('noBtn').innerHTML = 'Estás seguro de verdad, ¿Nikol?';
            document.getElementById('noBtn').style.backgroundColor = '#004f87';
            document.getElementById('sadGifContainer').style.display = 'none';
            document.getElementById('sadGifContainer2').style.display = 'none';
        ...
        case 3:
            ...
            document.getElementById('noBtn').innerHTML = '¿Porque sigues presionando que no?';
            document.getElementById('noBtn').style.backgroundColor = '#004f87';
        ...
        case 4:
            ...
            document.getElementById('noBtn').innerHTML = 'Di que si, Esta baratica';
            document.getElementById('noBtn').style.backgroundColor = '#004f87';
        ...
        case 6:
            ...
            document.getElementById('noBtn').innerHTML = 'Si, dices que estaré muy feliz';
            document.getElementById('noBtn').style.backgroundColor = '#004f87';
        ...
        case 10:
            ...
            document.getElementById('noBtn').innerHTML = 'Vale, ya dejaré de preguntar... Hazlo que tu quieras :C';
            document.getElementById('noBtn').style.backgroundColor = '#004f87';
        ...
        case 12:
            ...
            document.getElementById('noBtn').innerHTML = 'Ultima oportunidad di que siii';
            document.getElementById('noBtn').style.backgroundColor = '#004f87';
        ...
        case 13:
            ...
            document.getElementById('noBtn').innerHTML = "Era relajando pero di que siiiiii";
            document.getElementById('noBtn').style.backgroundColor = '#004f87';
